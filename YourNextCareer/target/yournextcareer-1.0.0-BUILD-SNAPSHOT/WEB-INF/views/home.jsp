	...
	<nav class="navbar navbar-default navbar-fixed-top topnav"
		...
		<div class="container topnav">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand topnav" href="${pageContext.request.contextPath}/home.htm">Your Next Career!</a>
			</div>
						...
						<li class="dropdown" id="menuLogin"><a
							...
							<div class="dropdown-menu" style="padding: 17px;">
								...
								<div class="text-center" style="padding: 10px 0">
									...
									<!-- Main Form -->
									<a href="${pageContext.request.contextPath}/checkPassword.htm">Forgot Password? Click here! </a>
