		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li><a href="${pageContext.request.contextPath}/settings.htm"><i
									...
									<tbody>
										<c:forEach var="job" items="${jobsList}">
											<tr>
												...
												<td><a href="${pageContext.request.contextPath}/employerViewApplications/${job.jobID}.htm"
														class="btn btn-primary">View applications</a></td>
											</tr>
										</c:forEach>
