					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<form action="${pageContext.request.contextPath}/changedStatus/${status.appId}.htm" method="post">
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<tr>
												...
												<td>${status.person.firstName}</td>
												<td><a
													href="${pageContext.request.contextPath}/download/${status.appId}.htm">Download
														Resume</a></td>
												<!-- <td>Date</td> -->
												<td><select class="form-control" name="status">
													...
													<button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Change
														status</button></td>
											</tr>
